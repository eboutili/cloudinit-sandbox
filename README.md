...
sometimes "ubuntu", etc.). In this example the account is called kubeplay: It
...
#
# Remember to replace the public key for the kubeplay user with your own public key.
#
```
